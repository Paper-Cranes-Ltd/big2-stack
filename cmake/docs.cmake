if(BIG2_BUILD_DOCS)
    ...
    if(DOXYGEN_FOUND)
        ...
        set(DOXYGEN_HTML_HEADER "${CMAKE_CURRENT_SOURCE_DIR}/docs/templates/header.html")
        set(DOXYGEN_HTML_FOOTER "${CMAKE_CURRENT_SOURCE_DIR}/docs/templates/footer.html")
        set(DOXYGEN_HTML_STYLESHEET "${CMAKE_CURRENT_SOURCE_DIR}/docs/templates/style.css")
